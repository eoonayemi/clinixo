...
const Header = () => {
  return (
    <div className="flex flex-col md:flex-row bg-primary rounded-xl px-6 md:px-10 lg:px-20 justify-center">
      {/* --------- Header Left --------- */}
      ...
      <div className="flex md:w-[60%]">
        <img
          className="w-full mt-auto bottom-0 h-auto rounded-lg"
